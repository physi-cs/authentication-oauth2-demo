...
import com.zjlab.oauth2.config.OAuth2ClientProperties;
import com.zjlab.oauth2.config.OAuth2ServerProperties;
import com.zjlab.oauth2.consts.GrantType;
import com.zjlab.oauth2.entity.domain.ClientUser;
import com.zjlab.oauth2.entity.dto.TokenDTO;
import com.zjlab.oauth2.entity.vo.UserInfo;
...
public class TokenService {
    ...
    public void tryGetUserInfo(ModelAndView mv, ClientUser currentUser) {
        ...
        RequestEntity<MultiValueMap<String, String>> requestEntity
                = new RequestEntity<>(headers, HttpMethod.GET, URI.create("http://localhost:8088/user/demo"));
    ...
    private HttpHeaders getHttpHeaders() {
        ...
        httpHeaders.setBasicAuth(auth2ClientProperties.getClientId()
                //, auth2ClientProperties.getClientSecret()
        );
    ...
    private MultiValueMap<String, String> getHttpBody(String code) throws UnsupportedEncodingException {
        ...
        params.add("client_id", auth2ClientProperties.getClientId());
        params.add("client_secret", auth2ClientProperties.getClientSecret());
